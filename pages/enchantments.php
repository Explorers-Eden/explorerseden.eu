<?php
  ...
  $enchantmentsRow = get_generated_data('enchantments');
?>
<?php if ($enchantmentsRow): ?>
<script>window.EXPLORERS_EDEN_ENCHANTMENTS = <?= json_encode($enchantmentsRow['data']) ?>;</script>
<?php endif; ?>
